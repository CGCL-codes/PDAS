...
class Architect(object):
    ...
    def _backward_step(self, input_valid, target_valid):
        ...
        if count_ops > (0.6125 * self.total_ops):
            param_loss = 4 * math.log(count_ops / (0.5875 * self.total_ops))
        elif count_ops < (0.5625 * self.total_ops):
            param_loss = -4 * math.log(count_ops / (0.58755 * self.total_ops))
        else:
            param_loss = 0
