...
from prune_params2 import ResNet32_Channel_Prune
...
class Architect(object):
    ...
    def _backward_step(self, input_valid, target_valid):
        ...
        if count_ops > (0.85 * self.total_ops):
            param_loss = 3 * math.log(count_ops / (0.82 * self.total_ops))
        elif count_ops < (0.79 * self.total_ops):
            param_loss = -3 * math.log(count_ops / (0.82 * self.total_ops))
        else:
            param_loss = 0
