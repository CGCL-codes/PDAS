...
#default_cfg = [16, 16, 16, 16, 32, 32, 32, 64, 64, 64]
#default_cfg = [16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 32, 32, 32, 32, 32, 32, 32, 32, 32, 64, 64, 64, 64, 64, 64, 64, 64, 64]
...
class Architect(object):
    ...
    def _backward_step(self, input_valid, target_valid):
        ...
        if count_ops > (0.545 * self.total_ops):
            param_loss = 4 * math.log(count_ops / (0.52 * self.total_ops))
        elif count_ops < (0.495 * self.total_ops):
            param_loss = -4 * math.log(count_ops / (0.52 * self.total_ops))
        else:
            param_loss = 0
