...
class BasicBlock(nn.Module):
    ...
    def forward(self, x, weights):
        ...
        '''outA = ChannelWiseInterV1(out_convs[0], out1, out_channels)
        outB = ChannelWiseInterV1(out_convs[1], out1, out_channels)
        outC = ChannelWiseInterV1(out_convs[2], out1, out_channels)
        outD = ChannelWiseInterV1(out_convs[3], out1, out_channels)'''
